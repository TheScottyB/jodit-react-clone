 ...
 */
import { SpocketProduct, SpocketOrder } from '../types/spocket.types';
import { SquareCatalogObject, SquareOrder } from '../types/square.types';
...
export interface OrderSyncTask extends SyncTask {
  ...
  spocketOrders?: SpocketOrder[];
  squareOrders?: SquareOrder[];
